...
获取最新最前沿的可持续发展消息；     
能够搜索到自己想要的文章；  
不需要自己辨别文章是否可用，网站帮忙筛选好；  
##### 可持续性：
持续更新的高质量的文章；  
wordpress架站坚实的后盾，易用的操作；  
站长会常运营与维护网站，分享文章心得等，筛选留言；  
通过网站访问数据调整网站运营的规划；  
##### 可行性： 
使用site origin等插件对页面和文章进行排版布局的优化；  
在首页页面添加侧边栏小工具实现搜索和评论功能；  
wordpress架站的成本较低；  
...
![web](https://raw.githubusercontent.com/liuyu19/Web_operations/master/final/image/web.png)
...
70%的用户给网站打了8分，理由是该网站的整体色调排版是较为清楚明了的，只是图片所占的位置偏多，导致影响了加载的速度；10%的用户给网站打了9分；20%用户给网站打了10分，理由是整体风格和主题是搭配的。

根据访谈结果总结得知：用户最希望该网站的更新频率是每天一次或者两天更新一次，希望能将当天课堂上所学到的整理在该网站中，有利于用户第一时间回顾复习。

70%的用户希望在该网站中，可以看到自己在课堂上没明白的知识点（视频、文章等），可以及时复习巩固；30%的用户希望能多多看到作者的个人分享。
...
创新点（突破点）：
文章只有大量的文字，看起来较为的枯燥乏味；希望文章能将相关的视频相结合，这样效果会更好。网站中所涉及的课程还是较少，希望在后面能增加更多的课程或者是所涉及的范围更为广。
改进措施：
调整底部小工具的位置：
